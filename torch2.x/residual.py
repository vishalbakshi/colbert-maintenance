...
class ResidualCodec:
    ...
    def compress_into_codes(self, embs, out_device):
        ...
        for batch in embs.split(bsize):
            if self.use_gpu:
                torch.save(batch, f"{ROOT}/compress_batch.pt") # ADDED BY VISHAL
                torch.save(self.centroids, f"{ROOT}/compress_centroids.pt") # ADDED BY VISHAL
            ...
            torch.save(indices, f"{ROOT}/compress_indices.pt") # ADDED BY VISHAL
    ...
    def lookup_centroids(self, codes, out_device):
        ...
        centroids = []
        torch.save(self.centroids, f"{ROOT}/lookup_centroids_self_centroids.pt")
