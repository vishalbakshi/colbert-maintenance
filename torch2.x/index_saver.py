...
class IndexSaver():
    ...
    def save_chunk(self, chunk_idx, offset, embs, doclens):
        compressed_embs = self.codec.compress(embs, chunk_idx) # chunk_idx ADDED BY VISHAL
        torch.save(compressed_embs, f"{ROOT}/compressed_embs_{chunk_idx}.pt") # ADDED BY VISHAL
