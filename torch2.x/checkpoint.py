...
#ROOT = "/colbert-maintenance/torch2.x/20250815-0.2.22.main.torch.1.13.1-1"  # ADDED BY VISHAL
#ROOT = "/colbert-maintenance/torch2.x/20250815-0.2.22.main.torch.2.0.1-1" # ADDED BY VISHAL 
#ROOT = "/colbert-maintenance/torch2.x/20250815-0.2.22.main.torch.2.1-1"    # ADDED BY VISHAL
...
class Checkpoint(ColBERT):
    ...
    def docFromText(
        ...
        if bsize:
            ...
            torch.save((text_batches, reverse_indices), f"{ROOT}/tensorize_output.pt") # ADDED BY VISHAL
            ...
            torch.save(batches, f"{ROOT}/batches.pt") # ADDED BY VISHAL
            ...
            if keep_dims is True:
                ...
                torch.save(D, f"{ROOT}/D.pt") # ADDED BY VISHAL
                if pool_factor > 1:
